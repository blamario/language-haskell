...
type family SynAtts l pos s con g where
  ...
  SynAtts l pos s con (AST.TypeVarBinding l l) = (Maybe (AST.Name l), Maybe (Abstract.Kind l l Identity Identity))
  SynAtts l pos s con (AST.Context l l) = con
...
instance (Abstract.Haskell l,
  ...
  attribution TypeCheck{constrain} (i, AST.VariableLHS name) (AG.Inherited env, _) =
...
instance (Abstract.Haskell l,
  ...
  attribution TypeCheck{constrain} (i, AST.FunctionalDependency lhs rhs) (AG.Inherited env, _) =
...
instance (Abstract.Haskell l,
  ...
  attribution TypeCheck{} (i, AST.Default) _ = (AG.Synthesized $ Success (), AST.Default)
...
instance (Abstract.Haskell l,
  ...
  attribution TypeCheck{constrain} (i, AST.NormalRHS{}) (AG.Inherited env, AST.NormalRHS (AG.Synthesized patSyn)) =
...
instance (Abstract.Haskell l,
  ...
  attribution TypeCheck{constrain} (i, AST.Constructor name types) (AG.Inherited env, _) =
    (AG.Synthesized $ Success (), AST.Constructor name $ AG.Inherited env <$ types)
...
instance (Abstract.Haskell l,
  ...
  attribution TypeCheck{} (_, AST.ImplicitlyKindedTypeVariable inf name) _ =
    (AG.Synthesized $ Success (Just name, Nothing), AST.ImplicitlyKindedTypeVariable inf name)
...
instance (Abstract.Haskell l,
  ...
  attribution TypeCheck{constrain} (_, AST.NoContext) _ = (AG.Synthesized $ Success constrain.empty, AST.NoContext)
